import argparse, collections, difflib, enum, hashlib, operator, os, stat, struct, sys, time, urllib.request, zlib
...
IndexEntry = collections.namedtuple('IndexEntry', [
    ...
    'mode', 'uid', 'gid',   # File permissions, user ID, group ID
    'size', 'sha1',         # File size and content hash
    'flags', 'path'         # Metadata flags and file path
])
